...
- compile-core 核心编译逻辑
  ...
  - 基础类型解析 v-for 、v-on
    ...
    ![image-20200713183256931](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
...
- compile-dom 针对浏览器的编译逻辑
  ...
  - v-clock
    ...
    ![image-20200713183210079](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800" height="600"></svg>)
